...
namespace FontIconsLib.MaterialIcons
{
	class Outlined : FontIconSetBase
    {
		internal Outlined() : base(Properties.Resources.MaterialIconsOutlined) { }

        public override string Name { get; } = "Material Icons - Outlined";

        public override string Version { get; } = "2022-09-09";
